...
if __name__ == '__main__':
    ...
    parser.add_argument('--din', default='/home/aerin/Desktop/sqlova/data/WikiSQL-1.1/data', help='data directory')
    parser.add_argument('--dout', default='/home/aerin/Desktop/sqlova/data/wikisql_tok', help='output directory')
