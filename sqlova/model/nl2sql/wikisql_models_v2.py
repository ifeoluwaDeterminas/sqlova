...
class Seq2SQL_v2(nn.Module):
    ...
    def beam_forward_sqlmax(self, wemb_n, l_n, wemb_hpu, l_hpu, l_hs,
                     nlu_t, nlu_wp_t, wp_to_wh_index, nlu, g_wvi,
                     beam_size=6,
                     show_p_sc=False, show_p_sa=False,
                     show_p_wn=False, show_p_wc=False, show_p_wo=False, show_p_wv=False):
        """
        ...
        for i_op  in range(self.n_cond_ops-1):
            ...
            # wv
            s_wv = self.wvp(wemb_n, l_n, wemb_hpu, l_hpu, l_hs, wn=pr_wn_max, wc=pr_wc_max, wo=pr_wo_temp, show_p_wv=show_p_wv, g_wvi=g_wvi) # [1,6,15,2]
